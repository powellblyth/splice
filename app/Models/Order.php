...
//        $this->is_test = true;
        ...
        if ($this->save()) {
            ...
            if (is_array($order->SalesOrderLines)) {
                ...
                // If we have updated the delivery method or the couerier, then resave this object
    ...
    public function order_lines(): \Illuminate\Database\Eloquent\Relations\HasMany {
